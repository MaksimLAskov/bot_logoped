...
bot.onText(/\/start/, (msg) => {
    ...
    bot.sendMessage(msg.chat.id, `Привет, ${msg.from.first_name}! Я бот для вопросов. Напиши мне свой вопрос, и я передам его главному логопеду нашей страны Архиповой Надежде Михайловне. Напишите свое ФИО и проблему в одном сообщении. Ожидайте ответа в течение 15 минут. `, {
        reply_markup: {
